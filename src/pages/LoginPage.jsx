...
const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
        ...
        {/*---- left ----*/}
        <div >
            <img src={assets.logo1} alt="" className='w-[min(30vw, 250px)] w-40'/>

            <p className='text-5xl  rounded-2xl p-3 text-gray-100 mt-8'>NarahsNow</p>
        </div>
        ...
        <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg cursor-pointer'>
