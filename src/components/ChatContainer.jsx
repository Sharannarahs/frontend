...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    ...
    <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
        ...
        <img onClick={handleSendMessage} src={assets.send_button2} alt="App Logo" className='w-7 cursor-pointer'/>
    </div>
    ...
    <div className='flex flex-col items-center justify-center gap-2 text-gray-500 bg-[#000000]/90 max-md:hidden'>
      <img src={assets.logo1} alt="App Logo" className='max-w-30' />
      <p className='text-3xl font-medium text-gray-200 ' >Chat anytime, anywhere</p>
    </div>
  );
}
